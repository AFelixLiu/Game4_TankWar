...
class MyTank(pygame.sprite.Sprite):
    def __init__(self, playerNumber):  # 初始化
        ...
        self.life = 3  # 初始化坦克生命
        self.bulletNotCooling = True  # 初始化子弹未冷却
        self.bullet = bulletClass.Bullet()  # 为坦克创建子弹对象

    def shoot(self):
        self.bullet.life = True  # 赋予子弹生命
    ...
    def moveUp(self, tankGroup, brickGroup, ironGroup):
        self.rect = self.rect.move(self.speed * 0, self.speed * -1)  # 移动并返回新位置
        # 更改坦克方向图片
        self.tank_R0 = self.tank.subsurface((0, 0), (48, 48))
        self.tank_R1 = self.tank.subsurface((48, 0), (48, 48))
        self.dir_x, self.dir_y = 0, -1  # 修改子弹方向
